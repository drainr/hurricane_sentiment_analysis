...
SOURCES = {
    ...
    "reddit_relevant_posts":       ("reddit_relevant_posts_vader.csv",       "reddit_relevant_posts_vader_roberta.csv",       "reddit_relevant_posts_vader_roberta_topics_labeled.csv",       3413),
    "reddit_relevant_comments":    ("reddit_relevant_comments_vader.csv",    "reddit_relevant_comments_vader_roberta.csv",    "reddit_relevant_comments_vader_roberta_topics_labeled.csv",    121053),
