...
This is a value judgment (comparability vs. correctness) for the advisor to settle, and should be stated as such wherever the primary method is named — not framed as "the data supports VADER." Our recommendation: **lead with RoBERTa as the primary reported scorer and carry VADER as the continuity baseline / cross-check.**
