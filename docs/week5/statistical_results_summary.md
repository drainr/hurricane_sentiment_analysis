...
| **H4** Cross-storm shift within platform         | Kruskal-Wallis + pairwise                 | **Significant** both platforms (Reddit H=116 p≈8e-26; FB H=249 p≈1e-54); Milton most negative; effect sizes small, FB shifts _more_ than Reddit | **Significant** (Reddit H=245; FB H=644 p≈1e-140); same pattern, FB shift larger                                                              | ✅ direction agrees                       |
...
- **Agreements (all qualitative conclusions match):** H1 supported, H2 rejected, H3 rejected, H4 significant with the same Debby→Milton direction, H7 WH more negative than both Reddit and Facebook and political WH comments more negative than non-political. The two methods agree on **every hypothesis verdict** computed so far.
